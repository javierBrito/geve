...
public class NumerosLetras {
 ...
 public static void main(String[] args)   {
	 NumerosLetras numerosLetras = new NumerosLetras();
	 Double a = 8.94;
	 ////System.out.println("MAIN: " + numerosLetras.numerosAletras(a));  
}
 
 public String numerosAletras(Double numero){
	 NumerosLetras NLetra = new NumerosLetras();
	 String numeroStr = "" + numero;
	   StringTokenizer tokens=new StringTokenizer(numeroStr,".");
	   int i = 0;
	   Integer entero = 0;
	   Integer decimal = 0;
	   String A = "";
	   ...
	   while(tokens.hasMoreTokens()){
	           ...
	           if(i==0){
	        	   ...
	        	   entero = Integer.parseInt(token);
	        	   A = NLetra.convertirLetras(entero);
	        	   ////System.out.println("Primer entero: " + A);
	           }else{
                   ////System.out.println(i + " " + token);
                   char[] decimales = token.toCharArray();
                   Integer temp = Integer.parseInt(""+decimales[0]);
                   if(temp == 0){
                       decimal = Integer.parseInt(token);
                       B = " CERO "+NLetra.convertirLetras(decimal);
                       ////System.out.println("Segudno entero: " + B);

                   }else{
                       decimal = Integer.parseInt(token);
                       B = NLetra.convertirLetras(decimal);
                       ////System.out.println("Segudno entero: " + B);
                   }
	           }
	           i++;
	   }
     String promedioStr = A + " coma " + B;
     promedioStr= promedioStr.toUpperCase();
	   return promedioStr;
